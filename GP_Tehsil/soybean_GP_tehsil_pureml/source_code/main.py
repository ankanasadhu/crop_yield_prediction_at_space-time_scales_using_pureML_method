...
class CodeRun:
    def __init__(self, args):
        ...
        self.J_value =5#Setting the iteration value for M-STAC (model hyperparameter)
        self.aplha= 1
        if self.args.pred_time=='15_days':
            self.ftr_name = "../data/ftr_names_soybean_15d.txt"
        elif  self.args.pred_time=='1_month':
            self.ftr_name = "../data/ftr_names_soybean_1m.txt"
        elif self.args.pred_time=='2_months':
            self.ftr_name = "../data/ftr_names_soybean_2m.txt"
