...
#calculating sMAPE for test data
if __name__ == '__main__':
    data_path = '../groundnut_data/'
    models_path = '../groundnut_models/'
    mstac_models_path = models_path + 'Ridge_model_pureML2'
    parser = argparse.ArgumentParser()
    parser.add_argument('--test_pred_path', type=str, default=data_path + 'Test_prediction.csv')##Change the file according to user need
    parser.add_argument('--test_yield_data_path', type=str, default=data_path + 'Test_yield_TN.csv')
    parser.add_argument('--num_districts', type=int, default=28)
